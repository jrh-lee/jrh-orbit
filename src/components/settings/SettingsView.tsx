    ...
    <div className="flex-1 overflow-y-auto p-6">
      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-1 max-w-md text-sm">
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+1</kbd>
          <span className="text-ink-2">Daily</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+2</kbd>
          <span className="text-ink-2">Notes</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+3</kbd>
          <span className="text-ink-2">Tasks</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+4</kbd>
          <span className="text-ink-2">Search</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+5</kbd>
          <span className="text-ink-2">Statistics</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+6</kbd>
          <span className="text-ink-2">Settings</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+K</kbd>
          <span className="text-ink-2">Quick Search</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+N</kbd>
          <span className="text-ink-2">Notes View</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+D</kbd>
          <span className="text-ink-2">Daily View</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+T</kbd>
          <span className="text-ink-2">Tasks View</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+,</kbd>
          <span className="text-ink-2">Settings</span>
          <kbd className="text-[11px] font-mono bg-paper-soft px-1.5 py-0.5 rounded border border-border text-ink text-center">Cmd+Shift+N</kbd>
